...
REGISTROS = [
    ...
    {"data": DATA, "obra": "RCE RAULZITO TRECHO 1", "equipe": "Valter", "atividade": "VCA, PVs e Ligações", "trecho": "PI 70 ao PI 71", "pv": ""},
    {"data": DATA, "obra": "RCE RAULZITO TRECHO 2", "equipe": "Edvando", "atividade": "VCA, PVs e Ligações", "trecho": "PV 49.3 ao PI 49", "pv": ""},
    ...
    {"data": DATA, "obra": "RCE RAULZITO TRECHO 2", "equipe": "Jhonatan", "atividade": "VCA, PVs e Ligações", "trecho": "PI 78 ao 79", "pv": ""},
    {"data": DATA, "obra": "RCE SÃO LUCAS", "equipe": "Kaique e Miro", "atividade": "Reposição e acabamentos", "trecho": "", "pv": ""},
    {"data": DATA, "obra": "LAVAGEM REDE", "equipe": "Gabriel", "atividade": "RCE Elvira e CTS Lageado", "trecho": "", "pv": ""},
    ...
    {"data": DATA, "obra": "Vacal", "equipe": "Lavagem Rede - Henko (Wellington)", "atividade": "Vacal", "trecho": "", "pv": ""},
